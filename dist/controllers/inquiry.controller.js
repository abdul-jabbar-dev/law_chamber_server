...
const createInquiry = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const inquiry = yield inquiryService.createInquiry(req.body);
...
const getInquiries = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const inquiries = yield inquiryService.getInquiries();
...
const updateInquiryStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const inquiry = yield inquiryService.updateInquiryStatus(req.params.id, status);
        if (!inquiry) {
...
const deleteInquiry = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const inquiry = yield inquiryService.deleteInquiry(req.params.id);
        if (!inquiry) {
            return res.status(404).json({ success: false, error: "Inquiry not found" });
        }
